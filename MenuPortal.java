 ...
 * @author BestBoi
 */
public class MenuPortal extends javax.swing.JFrame {

    /**
     * Creates new form MenuPortal
     */
    public MenuPortal() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTextField1.setText("Menu Portal");

        jLabel3.setText("Email");

        jLabel4.setText("Suggestion");

        jCheckBox1.setText("Allow Notifications");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MenuPortal.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MenuPortal().setVisible(true);
            }
        });
    }
